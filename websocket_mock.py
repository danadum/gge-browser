...
class WebSocketAppMock:
    def __init__(self, url, on_open=None, on_message=None, on_error=None, on_close=None, on_send=None, game_url='https://empire.goodgamestudios.com', ws_server_port=8765):
